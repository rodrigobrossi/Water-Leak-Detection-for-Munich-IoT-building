...
class BDPNotifier():
    ...
    def notify(notification, tenant):
        ...
        if notification["ACTION"] == "ALARM":
            ...
            bdp_dbutil.createNotificationRecord(notification["NEW_INCIDENT_ID"], 1, users)
            ...
            bdp_dbutil.createNotificationRecord(notification["INCIDENT_ID"], 2, users)
    ...
    def _generateAlarmEmails(incident_id, users):
        ...
        params = {
            ...
            # TODO: Fix
            'link': 'http://0.0.0.0:8080/respond?nid=' + users[1]['NOTIFICATION_ID']
        }
    ...
    def _generateSnoozeEmails(notification, users):
        ...
        params = {
            'name': users[1]['USER_NAME'], 
            'handler': notification["RESPONDER"],
            # TODO: Fix
            'link': 'http://0.0.0.0:8080/respond?nid=' + users[1]['NOTIFICATION_ID']
        }
        print('[BDPNotifier] generating template with params {}'.format(params))
